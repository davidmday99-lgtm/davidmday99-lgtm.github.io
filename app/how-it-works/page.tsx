...
export default function Page() {
  return <MarketingPage eyebrow="A clearer private sale" title="From search to driveway, in five straightforward steps." intro="OwnerOnly Cars makes the signals around a private sale easier to see while keeping buyers and sellers in control of the transaction." sections={[
    ...
    { eyebrow: '03 / Review', title: 'Understand every badge', body: 'Identity, ownership documents, and vehicle history are reviewed separately so each badge has a specific, limited meaning. Automated document screening only adds risk flags; trained human review remains the final step.' },
