...
export default function Page() {
  return <MarketingPage eyebrow="Trust & safety" title="Useful checks, honest limits, safer habits." intro="Verification can reduce risk, but it cannot guarantee a safe transaction. OwnerOnly explains what was checked and what still requires your judgment." sections={[
    ...
    { eyebrow: 'Ownership', title: 'Title or registration review', body: 'A private ownership document is reviewed to compare the seller’s verified legal name and VIN. With the seller’s consent, automated screening can flag possible mismatches, poor legibility, or visible alteration. It cannot prove authenticity or make the final decision; a human reviewer approves or rejects the document.' },
