        ...
        <section className="grid min-h-[650px] border-b-2 border-navy bg-[#f8f4e9] lg:grid-cols-[1.02fr_.98fr]">
          <div className="retro-sunrise flex items-center border-navy px-5 py-16 sm:px-10 lg:border-r-[3px] lg:px-[max(3rem,calc((100vw-80rem)/2))] lg:py-24 lg:pr-14">
            <div className="max-w-2xl">
              ...
              <h1 className="retro-display mt-8 text-balance text-6xl uppercase leading-[.9] sm:text-8xl xl:text-[6.6rem]">
                Skip the lot.{' '}
                <span className="retro-display-teal block">
                  Meet the owner.
                </span>
              </h1>
              <p className="mt-7 max-w-xl text-lg leading-8 text-slate-200">
                Buy directly from verified private owners and avoid dealer
                markups. Clear checks, honest limits, and cars from people—not
                lots.
              </p>

              <div className="mt-9 grid grid-cols-2 border-[3px] border-b-0 border-white text-xs font-black uppercase tracking-wide">
                <a
                  className="bg-white px-4 py-3 text-center text-navy"
                  href="/search"
                >
                  Private-owner vehicles
                </a>
                <a
                  className="bg-[#f6b82b] px-4 py-3 text-center text-navy hover:bg-[#ffc642]"
              ...
              <form
                action="/search"
                className="border-[3px] border-white bg-white p-3 shadow-[9px_9px_0_#16b9ad]"
                aria-label="Search private-owner vehicles"
              >
                <div className="grid gap-2 sm:grid-cols-[1fr_160px_auto]">
                  <label className="flex h-14 items-center gap-3 border border-slate-300 px-4 text-slate-500 focus-within:border-teal-600">
                    ...
                    <Input
                      className="h-11 border-0 p-0 text-base shadow-none focus-visible:ring-0"
                      name="q"
                  ...
                  <Button
                    className="h-14 rounded-none bg-navy px-6 font-black uppercase tracking-wide text-white hover:bg-teal-700"
                    type="submit"
                  >
                    Search <ArrowRight />
                  </Button>
              ...
              <div className="mt-7 flex flex-wrap gap-x-6 gap-y-3 border-t border-white/20 pt-5 text-xs font-bold uppercase tracking-wide text-slate-200">
              ...
              <div className="mx-auto flex max-w-xl items-center justify-between gap-4">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em]">
                    Real owner. Clear signals.
                  </p>
                  <p className="mt-1 text-sm font-semibold">
                    Every live seller completes required checks first.
                  </p>
                </div>
                <Badge className="h-8 shrink-0 rounded-none border border-navy bg-white text-navy">
                  <CheckCircle2 /> Verified path
                </Badge>
              </div>
            </div>
          </div>
