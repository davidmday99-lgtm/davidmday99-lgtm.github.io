...
export const metadata: Metadata = {
  ...
  description:
    'Check a seller’s asking price against the Kelley Blue Book private-party value.',
};
      ...
      <main className="min-h-screen bg-[#f8f4e9] text-navy">
        <section className="border-b-2 border-navy bg-[#96d9ed] px-5 py-10 sm:px-8 lg:py-14">
          <div className="mx-auto max-w-7xl">
            <span className="block-label">Independent value check</span>
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-navy/75">
              Look up the vehicle’s Kelley Blue Book private-party value, then
              compare it with the seller’s asking price in one place.
            </p>
          </div>
        </section>
