      ...
      <div className="flex items-start gap-3 border-l-4 border-teal-600 bg-teal-50 p-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm leading-6 text-slate-600">
            Answer every question accurately. “Yes” answers are disclosures—not
          ...
          >
            ...
            <div className="space-y-4">
              {group.questions.map((question) => (
                <label
                  className="block text-sm font-bold leading-5 text-navy"
                  key={question.id}
                >
                  {question.label}
                  <select
  ...
  return (
    <div className="mt-8">
      <h3 className="text-xl font-black uppercase text-navy">
        Installed features and upgrades
      </h3>
          ...
          >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {group.features.map((feature) => (
                <label
                  className="flex items-start gap-2 text-sm leading-5 text-navy"
                  key={feature}
                >
                  <input
